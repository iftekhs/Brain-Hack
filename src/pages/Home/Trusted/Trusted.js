...
const Trusted = () => {
  return (
    <section className="py-8">
      <div className="dark:bg-slate-800 dark:text-white bg-cgray py-8 px-2 flex flex-col items-center justify-center">
        <h2 className="text-2xl font-bold">Trsuted by over 120 + companies</h2>
        <div className="container mx-auto mt-5 flex flex-wrap items-center justify-center gap-10">
          <img
            className="brand"
